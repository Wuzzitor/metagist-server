...
use Metagist\ServerBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MetagistServerBundle:Category')->findAll();
     ...
     * @Method("POST")
     * @Template("MetagistServerBundle:Category:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MetagistServerBundle:Category')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MetagistServerBundle:Category:edit.html.twig")
     */
