...
class CategorySchemaTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGroupNamesMustBeUnique()
    {
        ...
        $this->setExpectedException('\Metagist\ServerBundle\Validation\Exception');
        $this->schema = new CategorySchema($json);
    }
    ...
    {
        $schema = CategorySchema::create(__DIR__ . '/testdata/testcategories.json');
        $this->assertInstanceOf("\Metagist\ServerBundle\Validation\CategorySchema", $schema);
    }
